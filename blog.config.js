...
const BLOG = {
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || 1974, // e.g if leave this empty, current year will be used.
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'auto', // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [20, 7], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mystery Q', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '屎上最强博客👍', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://nblogs.qbobo.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Mystery Q‘s Blog', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '绰号——魔鬼残疾人', // 备案号 闽ICP备XXXXXXX
  ...
  POST_WAITING_TIME_FOR_404:
    process.env.NEXT_PUBLIC_POST_WAITING_TIME_FOR_404 || '20', // 文章加载超时时间，单位秒；超时后跳转到404页面
