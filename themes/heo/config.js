const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '1974-12-01', // 建站日期，用于计算网站运行的第几天
  ...
  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '圣旨📜', url: '/tag/必看' },
  HEO_HERO_CATEGORY_2: { title: '热门🔥', url: '/tag/热门' },
  HEO_HERO_CATEGORY_3: { title: '四大发明', url: '/tag/教程' },

  // 英雄区右侧推荐文章标签, 例如 [推荐] , 最多六篇文章; 若留空白''，则推荐最近更新文章
  HEO_HERO_RECOMMEND_POST_TAG: '教程',
